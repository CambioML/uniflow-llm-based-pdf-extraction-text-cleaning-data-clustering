...
class ReduceOp(Op):
    ...
    def _default_merge_func(self, value_dict1: Mapping[str, Any], value_dict2: Mapping[str, Any]) -> Mapping[str, Any]:
    ...
    def __call__(self, expand_1: Node, expand_2: Node) -> Sequence[Node]:
        ...
        # Create the output node (replace with appropriate Node creation logic)
        reduce_1 = Node(value_dict=merged_dict)
