...
class OpenAINewsFeedFlow(Flow):
    ...
    def __init__(
        ...
        print("DEBUG question bank in session: ", question_banks)
        ...
        Given the question, consider if the question is relevant to the context. If so, generate an answer. If not, respond with 'answer: N/A'.
