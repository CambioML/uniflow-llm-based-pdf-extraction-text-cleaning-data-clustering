...
from uniflow.flow.transform.transform_google_multimodal_flow import GoogleMultiModalModelFlow, TransformGoogleMultiModalModelFlow
...
class TestGoogleMultiModalModelFlow(unittest.TestCase):
    ...
    def setUp(self, mock_model_op, mock_mm_model):
        ...
        self.google_mm_flow = GoogleMultiModalModelFlow(self.prompt_template, self.model_config)
